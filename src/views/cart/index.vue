              ...
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <!-- 选择规格组件 -->
                    <CartSku @change="$event=>updateCartSku(item.skuId,$event)" :skuId="item.skuId" :attrsText="item.attrsText"></CartSku>
                  </div>
                </div>
              </td>
              <td class="tc">
...
// import XtxButton from '@/components/library/xtx-buttonbox.vue'
...
export default {
  ...
  setup () {
    ...
    return { checkAll, deleteCart, checkOne, batchDeleteCart, changeCount, updateCartSku }
  }
}
</script>
